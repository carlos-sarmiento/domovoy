...
class ServEntEntity:
    ...
    async def set_to(self, state, attributes: dict[str, Any] | None = None) -> None:
        if attributes is not None and type(attributes) is not dict:
            raise DomovoyException("Attributes is not a dict")
...
class ServEntBinarySensor(ServEntEntity):
    ...
    async def set_on(self, attributes: dict | None = None) -> None:
        return await super().set_to(True, attributes)

    async def set_off(self, attributes: dict | None = None) -> None:
        return await super().set_to(False, attributes)
...
class ServEntNumber(ServEntEntity):
    ...
    async def set_to(self, state: float | int, attributes: dict | None = None) -> None:
        return await super().set_to(state, attributes)
